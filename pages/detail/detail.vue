<template>
	<view>
		...
		<view class="footer">
			...
			<view class="btn">
				<view class="chat" @tap="toChat">{{text}}</view>
	  ...
	  <uni-list>
			<uni-list-item title="XXXXX" note="请联系我" thumb="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/460d46d0-4fcc-11eb-8ff1-d5dcf8779628.png"
			     thumb-size="lg" rightText="联系人" to="../show/show"></uni-list-item>
		</uni-list>
...
export default {
	...
	onLoad(option) {
		...
		const iimg = object.img
		iimg.forEach((item,index) => {
			let use = {}
			use.id = index + 1
			use.img = item
			console.log(use)
